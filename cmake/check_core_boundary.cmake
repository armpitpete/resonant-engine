...
set(FORBIDDEN_INCLUDE_REGEX "#[ \t]*include[ \t]*[<\"][^>\"]*(juce|vst|emscripten|windows\\.h|unistd\\.h|CoreAudio|AudioToolbox)[^>\"]*[>\"]")
...
message(STATUS "resonant_core dependency boundary check passed (${CORE_DIR})")
